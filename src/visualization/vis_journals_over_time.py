...
def create_journals_over_time(journals, documents, years, output_folder, normalize=False, skip_last_year=False):
    journal_year = {}
    ...
    output_file(os.path.join(output_folder, 'journals_over_time.html'))
    p = figure(
