...
class SciHub(object):
    ...
    def search(self, query, limit=10, download=False, google_abuse=None):
        """
        ...
        while True:
            try:
                res = self.sess.get(SCHOLARS_BASE_URL, params={'q': query, 'start': start, 'google_abuse': google_abuse})
    ...
    def _search_direct_url(self, identifier):
        ...
        if iframe:
            ...
            print self.base_url + identifier, res.content
    ...
    def _generate_name(self, res):
        ...
        return '%s-%s' % (pdf_hash, name[-1 * min(20, len(name)):])
